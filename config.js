...
const CONFIG = {
  ...
  storage: {
    ...
    constellations: "janeDoeConstellations",
    theme: "color-theme",
  ...
  sync: {
    enabled: true,
    // Unique namespace for this deployment (change this to a new UUID for each deployment)
    namespace: "for-you-sync-54db246c-88d3-4521-a03e-570aea6bf55b",
    
    // Static encryption key (32-byte base64) - change for production use
    encKey: "zbsNbdEx2qOsr+uxHlmOWGg4OMhuhkKqD2iDsYb9Fu0=",
    
    // Sync intervals and configuration
    intervalMs: 15000,        // Background sync every 15 seconds
    retryDelayMs: 5000,       // Retry failed syncs after 5 seconds
    maxRetries: 3,            // Maximum retry attempts
    batchSize: 50,            // Records per sync batch
    
    // Cloudflare Worker endpoint (set to null to disable remote sync)
